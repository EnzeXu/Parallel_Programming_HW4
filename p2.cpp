...
int main(int argc, char** argv) {
    ...
    // start timer
    double start, time_comm = 0.0, time_comp = 0.0;
    ...
    if(!rank) {
        ...
        printf("[Time cost for m = %d, n = %d, p = %d, pr = %d, pc = %d] All: %.12lfs, Communication: %.12lfs, Computation: %.12lfs\n", m, n, nProcs, pr, pc, time_comm + time_comp, time_comm, time_comp);
    }
